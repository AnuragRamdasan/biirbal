        ...
        <div className="flex-shrink-0 w-20 h-20 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center border-r border-gray-100">
          {link.audioFileUrl && link.processingStatus === 'COMPLETED' ? (
            <Button 
              ...
              size="lg"
              className={cn(
                'w-14 h-14 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300',
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex-shrink-0 hidden sm:block">
              {link.ogImage ? (
                ...
                <div className="w-18 h-18 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center border border-gray-200">
