...
export async function generateMetadata({ params }: ArticlePageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://biirbal.ai/feed/${article.slug}`,
    ...
    alternates: {
      canonical: `https://biirbal.ai/feed/${article.slug}`
    }
  }
}
...
export default async function ArticlePage({ params }: ArticlePageProps) {
  ...
  const articleStructuredData = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://biirbal.ai/feed/${article.slug}`
    },
  ...
  const breadcrumbStructuredData = {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 3,
        "name": article.title,
        "item": `https://biirbal.ai/feed/${article.slug}`
      }
    ]
  }
