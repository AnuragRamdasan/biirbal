    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white text-center py-2 px-4">
        <div className="flex items-center justify-center gap-2 text-sm font-medium">
          ...
          <a href="#" className="underline hover:no-underline">Check us out →</a>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-20">
          <div className="mb-6">
            <span className="inline-block px-4 py-2 bg-purple-600/20 text-purple-300 rounded-full text-sm font-medium mb-6">
          ...
          <div className="flex items-center justify-center gap-8 mb-8 text-gray-400 text-sm">
            <div className="flex items-center gap-2">
              <div className="flex -space-x-2">
                ...
                <div className="w-8 h-8 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full border-2 border-slate-900"></div>
                <div className="w-8 h-8 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full border-2 border-slate-900"></div>
              </div>
          ...
          {installed && (
            <div className="bg-green-900/20 border border-green-400/30 text-green-300 px-6 py-4 rounded-xl mb-8 max-w-md mx-auto backdrop-blur-sm">
              ✅ Successfully installed! The bot is now monitoring your channels.
            </div>
          )}

          {error && (
            <div className="bg-red-900/20 border border-red-400/30 text-red-300 px-6 py-4 rounded-xl mb-8 max-w-md mx-auto backdrop-blur-sm">
              ❌ {error}
            </div>
          )}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="group relative inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-purple-500/25"
            >
              ...
              Start Free Trial
              <div className="absolute -top-3 -right-3 bg-orange-500 text-white text-xs px-2 py-1 rounded-full font-bold animate-pulse">
                FREE
              </div>
            </a>
            <a
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Loved by 1,200+ Teams</h2>
            <p className="text-gray-300 text-lg">See what teams are saying about their productivity boost</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Head of Product, TechFlow</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full mr-4"></div>
                <div>
                  <p className="text-white font-semibold">Marcus Rodriguez</p>
                  <p className="text-gray-400 text-sm">Engineering Manager, DataCore</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-gradient-to-r from-green-400 to-emerald-400 rounded-full mr-4"></div>
                <div>
                  <p className="text-white font-semibold">Alex Thompson</p>
                  <p className="text-gray-400 text-sm">CTO, RemoteFirst</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-200">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Smart Link Detection</h3>
          ...
          <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-200">
            ...
            <h3 className="text-xl font-bold text-white mb-3">AI Content Extraction</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-200">
            ...
            <h3 className="text-xl font-bold text-white mb-3">Premium Audio Summaries</h3>
            <p className="text-gray-300 leading-relaxed">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg">Start free, scale as you grow</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10">
              <div className="mb-6">
                ...
                <p className="text-gray-400 text-sm mt-2">Perfect for small teams</p>
              </div>
              ...
              <button className="w-full py-3 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-colors border border-white/20">
                Start Free Trial
              </button>
            </div>
            
            {/* Pro Plan - Popular */}
            <div className="bg-gradient-to-b from-purple-900/50 to-pink-900/50 backdrop-blur-sm p-8 rounded-2xl border-2 border-purple-400/50 relative">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-300 text-sm mt-2">Most popular choice</p>
              </div>
              <ul className="space-y-3 mb-8">
              ...
              <button className="w-full py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-colors font-bold">
                Start Free Trial
              </button>
            </div>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-400">💳 All plans include a 7-day free trial • No setup fees • Cancel anytime</p>
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm p-12 rounded-2xl border border-white/10">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <p className="text-gray-400 text-sm">Drop any link in your Slack channel</p>
            </div>
            <div>
              ...
              <h4 className="text-white font-semibold mb-2">AI Extraction</h4>
              <p className="text-gray-400 text-sm">Our AI extracts key insights automatically</p>
            </div>
            <div>
              ...
              <h4 className="text-white font-semibold mb-2">Generate Audio</h4>
              <p className="text-gray-400 text-sm">Creates professional 90-second summary</p>
            </div>
            <div>
              ...
              <p className="text-gray-400 text-sm">Audio posted as thread reply</p>
            </div>
          </div>
        </div>
        ...
        <footer className="mt-20 pt-12 border-t border-white/10">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h4 className="text-white font-bold mb-4">📎 Slack Link Monitor</h4>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© 2024 Slack Link Monitor. All rights reserved.</p>
