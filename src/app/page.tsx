...
function HomeContent() {
  ...
  // Use consistent redirect URI based on actual deployment URL
  const getRedirectUri = () => {
    if (typeof window !== 'undefined') {
      return window.location.origin + '/api/slack/oauth'
    }
    // For SSR, use the actual Vercel URL (biirbal.vercel.app)
    return 'https://biirbal.vercel.app/api/slack/oauth'
  }
