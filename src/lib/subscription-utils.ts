...
/**
 * Update or create the subscription record for a team from Stripe event data.
 *
 * @param currentPeriodEnd - The actual period-end date from Stripe
 *   (e.g. new Date(event.data.object.current_period_end * 1000)).
 *   Falls back to now+30 days when callers omit it for backward compatibility.
 */
